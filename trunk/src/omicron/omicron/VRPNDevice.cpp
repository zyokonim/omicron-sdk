...
void vrpn_XInputGamepad::update(const Event& evt) {
	...
	*/
	...
	buttons[2] = (evt.getFlags() == Event::ButtonUp) != 0;
	buttons[3] = (evt.getFlags() == Event::ButtonDown) != 0;
	buttons[4] = (evt.getFlags() == Event::ButtonLeft) != 0;
	buttons[5] = (evt.getFlags() == Event::ButtonRight) != 0;
	buttons[7] = (evt.getFlags() == Event::Button7) != 0;
